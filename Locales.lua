...
elseif locale == "zhCN" then
	...
	L["PopUp"] = "弹出窗口"
	L["Professions"] = "职业"
	L["Quest pin tracking needs a mapID.\nSee https://wago.tools/db2/UiMap for help."] = "任务图标追踪需要一个地图ID。\n请参见 https://wago.tools/db2/UiMap 获取帮助。"
	L["Quest Pin"] = "任务图标"
	L["Quest type"] = "任务类型"
	L["QuestID"] = "任务ID"
	L["Recipes"] = "配方"
...
L["Quest pin tracking needs a mapID.\nSee https://wago.tools/db2/UiMap for help."] = "Для отслеживания значков заданий требуется mapID.\nСм. https://wago.tools/db2/UiMap для получения помощи."
